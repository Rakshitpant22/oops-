...
//~ 3. Handle Collisions
    ...
    // Linear me agar us hash bucket me hai koi to usse just next p value jaegi and for quadratic its uses function for same
...
//  LF = 50/100 = 0.5
//* IDEAL RANGE : 0.7 to 0.75 (IF GREATER THEN REHASHING IS TO BE DONE)ie:size increase kro bucket increase then rehash
